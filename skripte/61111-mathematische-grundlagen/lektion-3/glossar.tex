...
\gentry{7.2.11}{Bemerkung (Erweitern bzw. Abhängigkeit über Basisgröße)}{%
  Sei $V$ ein $K$-Vektorraum und $v_1,\ldots,v_n \in V$.
  \begin{enumerate}[label=(\alph*),topsep=2pt,itemsep=1pt]
...
\gentry{7.4.4}{Proposition ($n$ Vektoren bilden Basis bei $\dim V = n$)}{%
  Sei $\dim(V) = n < \infty$.
  \begin{enumerate}[label=(\alph*),topsep=2pt,itemsep=1pt]
...
\gentry{8.1.8}{Proposition (Umkehrung eines Isomorphismus)}{%
...
\gentry{8.2.6}{Korollar (Isomorphie über Dimensionsgleichheit)}{%
...
\gentry{8.3.5}{Korollar (Surjektivität über Basisbilder)}{%
...
\gentry{8.3.10}{Proposition (Injektivität $\Leftrightarrow$ trivialer Kern)}{%
...
\gentry{8.3.13}{Satz (Basis des Bildes über Kernergänzung)}{%
...
\gentry{8.3.17}{Korollar (Injektiv = surjektiv bei gleicher Dimension)}{%
...
\gentry{8.3.18}{Korollar (Charakterisierung von $f$ über Basisbilder)}{%
...
\gentry{8.4.6}{Korollar (Eindeutiger Isomorphismus mit $f(v_i)=w_i$)}{%
...
\gentry{9.1.2}{Proposition ($\mathrm{Hom}_K(V,W)$ ist Vektorraum)}{%
...
\gentry{9.2.1}{Proposition (Matrixdarstellung auf Koordinatenvektoren)}{%
...
\gentry{9.2.3}{Korollar (Kern isomorph zur Lösungsmenge)}{%
...
\gentry{9.2.4}{Korollar (Rang von $f$ = Rang der Matrixdarstellung)}{%
  $\mathrm{Rg}(f) = \mathrm{Rg}({}_C M_B(f))$.
  Rang der linearen Abbildung = Rang ihrer Matrixdarstellung.
}

\gentry{9.2.5}{Korollar (Rang = Spaltenrang = Zeilenrang)}{%
...
\gentry{9.3.3}{Korollar (Rang eines Matrizenprodukts)}{%
