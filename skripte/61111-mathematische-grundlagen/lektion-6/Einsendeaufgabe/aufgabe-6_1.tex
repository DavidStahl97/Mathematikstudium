...
Sei $x > 0$ beliebig. Wir definieren
\[
...
\[
  f'(t) = \frac{1}{1+t} - \frac{\sqrt{1+t} + t \cdot \dfrac{1}{\sqrt{1+t}}}{1+t}
  = \frac{1 - \sqrt{1+t} - t \cdot \dfrac{1}{\sqrt{1+t}}}{1+t}.
\]

Für alle $t > 0$ gilt $f'(t) < 0$, da der Nenner von $f'(t)$ immer positiv ist
und der Zähler wegen $\sqrt{1+t} > 1$ immer negativ ist.
