...
\lernkarte[61211-1-01]{Geordnete Menge}{%
  \begin{align*}
    & x \le x \\
...
\lernkarte[61211-1-02]{linear geordnete Menge}{%
  \[ x \le y \;\vee\; y \le x \]
  nach dieser Regel können je zwei Elemente verglichen werden.
}

\lernkarte[61211-1-03]{Regeln der Vergleichung}{%
  \[ 0 \le a \le b \,\wedge\, 0 \le c \le d \;\Rightarrow\; ac \le bd \]
}

\lernkarte[61211-1-04]{Cauchy-Schwarz Ungleichung}{%
...
\lernkarte[61211-1-05]{Supremum \& Infimum}{%
  \begin{align*}
...
\lernkarte[61211-1-06]{beschränkte Funktion}{%
  \[ \|f\|_\infty := \sup\{\, \|f(x)\| \;\mid\; x \in M \,\} \]
}

\lernkarte[61211-1-07]{Supremumsnorm}{%
...
\lernkarte[61211-1-08]{zweite Dreiecksungleichung}{%
  \[ \bigl|\,|x|-|y|\,\bigr| \;\le\; |x+y| \]
}

\lernkarte[61211-1-09]{Umgebung}{%
  \[ U_\varepsilon(a) := \{\, x \in \mathbb{R} \;\mid\; d(x,a) < \varepsilon \,\} \]
  \[ U_\varepsilon(a) \subseteq U \;\Rightarrow\; U \text{ ist Umgebung von } a \]
}

\lernkarte[61211-1-10]{Hausdorffeigenschaft}{%
...
\lernkarte[61211-1-14]{Bolzano-Weierstraß}{%
...
\lernkarte[61211-1-15]{bestimmte Divergenz (Kriterium)}{%
  Für jedes $n_0 \in \mathbb{N}$ liegen fast alle $a_k$ über $n_0$.
}

\lernkarte[61211-1-16]{Cauchykriterium}{%
...
\lernkarte[61211-1-19]{Folgenräume $W, \ell^\infty, c, c_0$}{%
  Unterräume:
  \[ W \supseteq \ell^\infty \supseteq c \supseteq c_0 \]
}

% --- OneNote-Seite 1.4 "R^n normierter Raum" -----------------------------
\lernabschnitt{1.4 $\mathbb{R}^n$ normierter Raum}

\lernkarte[61211-1-20]{Norm}{%
  \begin{align*}
...
\lernkarte[61211-1-21]{Supremumsnorm (Raum)}{%
  \[ \big(\, B(M),\ \|\cdot\|_\infty \,\big) \]
}

\lernkarte[61211-1-22]{Euklidische Norm}{%
  \[ \|x\|_2 := \sqrt{\sum_{k=1}^{n} x_k^2} \]
}

\lernkarte[61211-1-23]{Maximumnorm}{%
...
\lernkarte[61211-1-27]{Bolzano-Weierstraß (in $\mathbb{R}^n$)}{%
  \[ \|x_k\|_\infty \le S \;\Rightarrow\; \text{es existiert eine konvergente Teilfolge} \]
}

\lernkarte[61211-1-28]{Äquivalenz der Normen}{%
...
\lernkarte[61211-1-29]{Cauchyfolge (in $\mathbb{R}^n$)}{%
  \begin{align*}
    &\forall \varepsilon>0 \ \exists n_0\in\mathbb{N} \ \forall k\in\mathbb{N}:
...
\lernkarte[61211-1-30]{Banachraum}{%
