...
\begin{enumerate}[label=\alph*)]
    ...
    \]
    Demnach ist $c = (r, \sqrt{2}\, r, \sqrt{3}\, r)$ ein lokales Maximum unter der Nebenbedingung $g$. $c$ ist also auch nach Satz 4.5.9 das einzige Extremum von $f|_{M(g)}$.
    ...
    \]
    folgt. Also ist $M(g)$ abgeschlossen. $M(g)$ ist ebenfalls beschränkt nach der euklidischen Norm, da die Nebenbedingung äquivalent zu $\sqrt{x^2 + y^2 + z^2} = \sqrt{6}\, r$ ist. $M(g)$ ist nach der euklidischen Norm die Oberfläche der Kugel mit dem Radius $\sqrt{6}\, r$. $M(g)$ ist also kompakt. Demnach ist $c$ das Maximum von $f|_{M(g)}$.
