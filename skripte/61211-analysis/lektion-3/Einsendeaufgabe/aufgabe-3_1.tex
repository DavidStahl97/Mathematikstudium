...
\begin{enumerate}[label=\alph*)]
    ...
    \[
        D_1 f(x,y) = \begin{cases}
            \dfrac{4 \cos(x) \sin(x)^3 \, y^6 \, (x^2 + y^2) - \sin(x)^4 \, y^6 \cdot 2x}{(x^2 + y^2)^2} & \text{für } (x,y) \neq (0,0) \\[1em]
            0 & \text{für } (x,y) = (0,0)
        \end{cases}
    \]
    \[
        D_2 f(x,y) = \begin{cases}
            \dfrac{6 \sin(x)^4 \, y^5 \, (x^2 + y^2) - \sin(x)^4 \, y^6 \cdot 2y}{(x^2 + y^2)^2} & \text{für } (x,y) \neq (0,0) \\[1em]
            0 & \text{für } (x,y) = (0,0)
        \end{cases}
    \]
    ...
    Nach der gleichen Argumentation ist $D_2 f(x,y)$ die Ableitung von $(f \circ \iota_2)(y)$.
