...
\begin{enumerate}[label=\alph*)]
    ...
    Sei $\varepsilon > 0$ beliebig. Wir wählen $\delta := \min\!\left(1, \tfrac{\varepsilon}{3}\right)$.

    Dann gilt:
    \begin{align*}
        \left|\frac{3x^2 y^2 - 2xy^3}{2x^2+2y^2}\right|
        &\leq \frac{3x^2 y^2 + 2|xy^3|}{2(x^2+y^2)} \\
        &\leq \frac{3x^2 (x^2+y^2) + 2|xy|(x^2+y^2)}{2(x^2+y^2)} \\
        &= \frac{3}{2} x^2 + |xy| \\
        &< \frac{3}{2} \cdot \frac{\varepsilon}{3} + \frac{\varepsilon}{3} && \text{\parbox{6cm}{\raggedright (wegen $\left\|\binom{x}{y}\right\|_\infty^2 < \varepsilon$, da $\left\|\binom{x}{y}\right\|_\infty < 1$ und $\left\|\binom{x}{y}\right\|_\infty < \varepsilon$)}} \\
        &< \varepsilon
    \end{align*}

    Daraus folgt $\displaystyle\lim_{\binom{x}{y} \to 0} \frac{3x^2 y^2 - 2xy^3}{2x^2+2y^2} = 0$.

    Außerdem für $\delta := \min\!\left(1, \tfrac{\varepsilon}{8}\right)$ gilt
    \begin{align*}
        ...
        &\leq 4|x| + 4|y| \\
        &< \varepsilon && \text{(wegen $\left\|\binom{x}{y}\right\|_\infty < \delta \leq \tfrac{\varepsilon}{8}$)}
    \end{align*}
    ...
    \begin{align*}
        \lim_{\binom{x}{y} \to 0} D_2 f(x,y)
        &= \lim_{\binom{x}{y} \to 0} \frac{2yx^3 - 3y^2 x^2}{2x^2+2y^2}
         - \lim_{\binom{x}{y} \to 0} \frac{x^2 y^2 (x-y) \, 4y}{(2x^2+2y^2)^2} \\
        &= 0 = D_2 f(0,0)
    \end{align*}

    $D_2 f$ ist also stetig in $0$.
    Mit der gleichen Argumentation ist $D_1 f$ stetig in $0$.
