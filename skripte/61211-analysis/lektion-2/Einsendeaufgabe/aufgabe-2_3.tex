...
\begin{enumerate}[label=\alph*)]
    ...
    \item
          ...
          Für $x_1$ setzen wir $1$ und es gilt $f_1(x_1) = 1$. Da $f_1(x)$ streng monoton steigend ist, ist die Lösung eindeutig.

          \underline{Induktionsschritt: $n \to n+1$}

          Nach Induktionsvoraussetzung existiert ein eindeutiges $x_n > 0$ mit $f_n(x_n) = 1$. Es gilt $f_{n+1}(x_n) > 1$. Nach dem Zwischenwertsatz existiert ein $x_{n+1}$ mit $f_{n+1}(x_{n+1}) = 1$, da $0 = f(0) < 1 < f_{n+1}(x_n)$.
    ...
    \item
          ...
          Nicht gleichmäßig stetig bedeutet ist äquivalent zu:
          \[
              \exists \varepsilon > 0 \, \forall \delta > 0 \, \exists x, y \in (0, a) : (|x - y| < \delta \Rightarrow |f(x) - f(y)| \geq \varepsilon)
          \]
