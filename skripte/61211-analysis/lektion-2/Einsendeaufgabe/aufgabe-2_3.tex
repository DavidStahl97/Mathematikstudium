...
\begin{enumerate}[label=\alph*)]
    ...
    \item
          ...
          Wir zeigen durch Induktion, dass es eine eindeutige Lösung für $f_n(x_n) = 1$ existiert.
          ...
          Nach Induktionsvoraussetzung existiert ein eindeutiges $x_n > 0$ mit $f_n(x_n) = 1$. Es gilt $f_{n+1}(x_n) = 1 + x^{n+1} > 1$. Nach dem Zwischenwertsatz existiert ein $x_{n+1}$ mit $f_{n+1}(x_{n+1}) = 1$, da $f(0) < 1 < f_{n+1}(x_n)$.
          ...
          Die Folge $(x_n)$ ist streng monoton fallend, denn es gilt $f(x_{n+1}) < f(x_n)$ für alle $n \in \mathbb{N}$ wegen der Konstruktion der Folge $(x_n)$ und da $f$ in $[0, +\infty)$ streng monoton wächst, folgt $x_{n+1} < x_n$.

          Da also $(x_n)$ streng monoton fallend und beschränkt ist, konvergiert $(x_n)$. Der Grenzwert von $(x_n)$ ist noch zu ermitteln.
          ...
          \[
              \lim_{n \to \infty} f_n(x_n) = \lim_{n \to \infty} \sum_{k=0}^{n} (x_n)^k = \frac{1 - \lim_{n \to \infty} x_n^n}{1 - \lim_{n \to \infty} x_n} = \frac{1}{1 - \lim_{n \to \infty} x_n}
          \]
          ...
          Folglich gilt $\lim_{n \to \infty} x_n = 0$, was zu zeigen war.
