...
\begin{enumerate}[label=\alph*)]
    ...
    Wir definieren eine Folge $(x_k)$ mit $x_k := \left(\frac{1}{k}, \frac{1}{k}\right)$.

    Es gilt $x_k \to (0,0)$ in $(\mathbb{R}^2, \|\cdot\|_2)$.
    ...
    (da $|x_1 x_2| \leq x_1^2 + x_2^2$ wegen
