...
Wir untersuchen zunächst die Unterdeterminante $A'_{1,n+1}$. Wir vertauschen die letzte Zeile mit der vorletzten, dann mit der vorvorletzten usw., bis die letzte Zeile von $A'_{1,n+1}$ oben ist:
\[
A'_{1,n+1} =
\begin{pmatrix}
-1 & 1 & 0 & \cdots & 0 \\
...
Wir nennen das neue Minor $A''_{1,n+1}$. Da $A''_{1,n+1}$ eine Dreiecksmatrix ist, folgt
\[
