...
Wir untersuchen, für welches $t \in \mathbb{R}$ die Basen von $U$ und $W_t$ linear unabhängig sind.
Wenn sie linear unabhängig sind, folgt aus Lemma 2.3.19, dass $W_t$ ein Komplement von $U$ ist.
...
Demnach muss $t \neq -1$ sein, damit die Basisvektoren von $U$ und $W_t$ linear unabhängig sind.
Für $t \neq -1$ ist $W_t$ ein Komplement von $U$.
