...
\gentry{1.4.1b}{Grad des Nullpolynoms}{%
  Der Grad des Nullpolynoms wird definiert als $\deg(0) = -\infty$.
}

\gentry{1.4.1c}{Konstante Polynome}{%
  Die Polynome vom Grad $\leq 0$ heißen \textbf{konstante Polynome}.
}
