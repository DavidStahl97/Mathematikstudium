...
\gentry{1.2.23}{Lemma (Körper sind nullteilerfrei)}{Jeder Körper ist nullteilerfrei.}
...
\gentry{1.3.11}{Satz ($\mathbb{Z}/n\mathbb{Z}$ ist Ring)}{%
...
\gentry{1.4.3}{Grad, normiertes Polynom, konstante Polynome}{%
  Für $f = \sum_i a_i X^i \in K[X]$ mit $f \neq 0$ ist der \textbf{Grad} $\deg(f) = \max\{n \in \mathbb{N}_0 \mid a_n \neq 0\}$.
  Der Leitkoeffizient von $f$ ist $a_n$ (der Koeffizient des höchsten Grades). Ein Polynom $f \neq 0$ mit Leitkoeffizient $1$ heißt \textbf{normiert}.
  Für das Nullpolynom definiert man $\deg(0) = -\infty$. Die Polynome vom Grad $\leq 0$ heißen \textbf{konstante Polynome}.
}
...
\gentry{1.4.9}{Satz ($K[X]$ ist kommutativer Ring)}{$K[X]$ ist mit Addition und Multiplikation von Polynomen ein kommutativer Ring.}
...
\gentry{1.5.2}{Satz ($\mathbb{C}$ ist ein Körper)}{$\mathbb{C}$ ist ein Körper.}
