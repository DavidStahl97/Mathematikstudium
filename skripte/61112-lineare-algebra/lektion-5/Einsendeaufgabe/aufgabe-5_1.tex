...
\begin{enumerate}[label=\alph*)]
    ...
    \begin{align*}
        \mathfrak{a}(a) = 3 &= \dim(\operatorname{Ker}(O_3)) \\
    ...
    \[
        \gamma(\lambda) = 1 = \mathfrak{a}(\lambda) \quad\text{für jedes } \lambda \in \{\lambda_1, \lambda_2, \lambda_3\}
    \]
    ...
    Demnach $\gamma(0) < \mathfrak{a}(0)$. Nach Satz 5.3.20 ist $A$ nicht diagonalisierbar.
