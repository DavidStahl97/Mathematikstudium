...
\begin{enumerate}[label=\alph*)]
    ...
    \begin{align*}
        \alpha(a) = 3 &= \dim(\operatorname{Ker}(0_{3\times 3})) \\
    ...
    \[
        \gamma(\lambda) = 1 = \alpha(\lambda) \quad\text{für jedes } \lambda \in \{\lambda_1, \lambda_2, \lambda_3\}
    \]
    ...
    Demnach $\gamma(0) < \alpha(0)$. Nach Satz 5.3.20 ist $A$ nicht diagonalisierbar.
